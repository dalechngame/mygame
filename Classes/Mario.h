...
public:
	...
	enum _GROW{ NONE, BIG, FIRE } _grow;
...
private:
	...
	void moveMap(float);
	void setFrame(const char *frameName, Common::DIRECTION dir, _GROW grow, bool isAni = true);
	void setAction(const char *actionName, Common::DIRECTION dir, _GROW grow, bool forever = true);
